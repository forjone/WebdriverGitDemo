...
//        跳转回原来的窗口
        ...
        Driver.findElement(By.xpath(".//*[@id='mainPwdIpt']")).click();
        Thread.sleep(3000);
        WebElement msgRemindElement = Driver.findElement(By.xpath(".//*[@id='conflictTitle']"));
        String msgRemind = msgRemindElement.getAttribute("innerHTML");
        System.out.println("对象提示信息 : " + msgRemind);
//        String msgRemind1 = msgRemindElement.getAttribute("innerText");
//        System.out.println("对象提示信息 : " + msgRemind1);
